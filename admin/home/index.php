...
//hitung jml kategori
$query = mysqli_query($koneksi, "SELECT COUNT(id_kategori) AS jumlah_kategori FROM kategori");
$kategori = mysqli_fetch_array($query);


//hitung jml berita
$query = mysqli_query($koneksi, "SELECT COUNT(id_berita) AS jumlah_berita FROM tb_berita");
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            ...
                            <div class="stat-digit"></i><?= $kategori['jumlah_kategori'] ?></div>
                        </div>
                        <div class="progress">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            <div class="stat-text">Total Berita</div>
                            <div class="stat-digit"></i><?= $berita['jumlah_berita'] ?></div>
                        </div>
                        <div class="progress">
